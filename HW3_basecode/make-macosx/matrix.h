...
{
  this->_m->Val[0][0] = c1[0]; this->_m->Val[0][1] = c2[0]; this->_m->Val[0][2] = c3[0]; this->_m->Val[0][3] = 0;
  this->_m->Val[1][0] = c1[1]; this->_m->Val[1][1] = c2[1]; this->_m->Val[1][2] = c3[1]; this->_m->Val[1][3] = 0;
  this->_m->Val[2][0] = c1[2]; this->_m->Val[2][1] = c2[2]; this->_m->Val[2][2] = c3[2]; this->_m->Val[2][3] = 0;
  this->_m->Val[3][0] = 0;     this->_m->Val[3][1] = 0;     this->_m->Val[3][2] = 0;     this->_m->Val[3][3] = 1;
}
